...
export default function ResultPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-5 sm:px-6 py-10 sm:py-14 pb-24">
      ...
      <p className="text-sm font-medium text-sage-strong mb-2">판단 훈련 완료</p>
      <h1 className="font-serif text-2xl sm:text-3xl font-bold text-ink leading-snug">{headline}</h1>
      <p className="mt-2 text-sm text-ink-soft">
        “{scenario.situationTitle}” 상황을 {completion.nodes.length}번의 판단으로 지나왔어요.
      </p>
      ...
      {/* 대비 완료 배지 */}
      <div className="mt-9 flex items-center gap-2 text-sm text-sage-strong">
